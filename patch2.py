...
# Pattern to find the vertical search card and the Content wrapper
pattern = r'(        \{/\* Content \*/\}\n        <div className="relative z-10 px-8 sm:px-12 lg:px-16 pb-12 pt-36 lg:pt-44 flex flex-col lg:flex-row items-end justify-between gap-12 w-full">\n          <div className="max-w-xl w-full">.*?          </div>\n\n          \{/\* Right Search Box \*/\}.*?          </div>\n        </div>\n      </section>)'

new_content_block = """        {/* Content */}
        <div className="relative z-10 px-8 sm:px-12 lg:px-16 pb-12 pt-36 lg:pt-44 flex flex-col justify-between h-full">
          ...
          <div className="w-full flex flex-col items-end mt-12 lg:mt-0 relative z-30">
            <h3 className="text-white/90 font-bold text-[15px] mb-3 pr-4 flex items-center gap-2 drop-shadow-md">
              <Search className="w-4 h-4 text-rose-300" />
              Tìm Kiếm Nhanh Bạn Ghép
            </h3>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-full shadow-2xl p-2 border border-white/20 flex flex-col lg:flex-row items-center w-full lg:w-auto">
              ...
              <div className="relative w-full lg:w-[220px]">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[14px] font-bold text-white truncate max-w-[120px]">{selectedLocation}</span>
                    </div>
                  </div>
                ...
                {activeDropdown === 'location' && (
                  <div className="absolute top-full left-0 mt-3 w-full bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-fade-in-up">
                    {locations.map(loc => (
                      <div 
                        key={loc}
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[14px] font-bold text-white truncate max-w-[120px]">{selectedBudget}</span>
                    </div>
                  </div>
              ...
              <div className="relative w-full lg:w-[220px]">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[14px] font-bold text-white truncate max-w-[120px]">{selectedLifestyle}</span>
                    </div>
                  </div>
                ...
                {activeDropdown === 'lifestyle' && (
                  <div className="absolute top-full right-0 mt-3 w-full bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-fade-in-up">
                    {lifestyles.map(life => (
                      <div 
                        key={life}
...
new_content = re.sub(pattern, new_content_block, content, flags=re.DOTALL)
