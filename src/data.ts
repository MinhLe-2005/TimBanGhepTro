...
export const INITIAL_ROOMMATES: Roommate[] = [
  ...
  },
  {
    ...
    avatar: "/genz_hoangnam_student.png",
    status: "Đang tìm",
    ...
    matchScore: 92,
    reputationScore: 95,
    tags: ["Ngủ sớm", "Ngăn nắp", "Sinh viên IT"],
    isVerified: true,
    is_listing: true,
    bio: "Sinh viên năm 3 ngành CNTT hiền lành, thích code và nấu ăn ngon. Cần tìm một bạn nam ở ghép sạch sẽ khu vực gần trường Bách khoa, chia sẻ tiền phòng hàng tháng.",
    budget: 3000000,
    gender: "Nam",
    lifestyle: {
      sleep: "Ngủ sớm",
  ...
  },
  {
    ...
    school: "ĐH Duy Tân (Liên Chiểu)",
    phoneNumber: "0915 222 333",
    avatar: "/genz_ductri_student.png",
    status: "Đang tìm",
    ...
    isVerified: false,
    bio: "Sinh viên năm 2 ngành thiết kế đồ họa, thích chơi bóng rổ và tụ tập bạn bè cuối tuần. Tính tình cởi mở, thoải mái dọn dẹp cuối tuần. Cần roommate sòng phẳng tài chính và có chung sở thích thể thao.",
    budget: 2500000,
    gender: "Nam",
    lifestyle: {
      sleep: "Cú đêm",
